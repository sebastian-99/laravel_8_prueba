...
<body>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{route("upload_gestion_sectores")}}" method="POST"  class="needs-validation" novalidate>
                @csrf
                <label for="nombre">Nombre sector</label>
                <input class="form-control" type="text" name="nombre_sector" id="nombre" value="{{$name}}"required>
